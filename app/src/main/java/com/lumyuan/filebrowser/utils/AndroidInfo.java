...
public class AndroidInfo {
    ...
    public int cpuCoreNum(){
        ...
        for (String i : file.list()){
            if(i.indexOf("cpu0")!=-1 ||i.indexOf("cpu2")!=-1||i.indexOf("cpu3")!=-1||i.indexOf("cpu4")!=-1
                    ||i.indexOf("cpu5")!=-1||i.indexOf("cpu6")!=-1||i.indexOf("cpu7")!=-1||i.indexOf("cpu8")!=-1||i.indexOf("cpu9")!=-1||i.indexOf("cpu1")!=-1){
                num = num + 1;
            }
        }
        return num;
