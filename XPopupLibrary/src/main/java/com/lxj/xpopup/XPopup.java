...
public class XPopup {
    ...
    public static class Builder {
        ...
        public AttachListPopupView asAttachList(String[] data, int[] iconIds, int imageColor, int textColor, OnSelectListener selectListener, int bindLayoutId,
                                                int bindItemLayoutId, int contentGravity) {
            AttachListPopupView popupView = new AttachListPopupView(this.context, bindLayoutId, bindItemLayoutId, imageColor, textColor)
                    .setStringData(data, iconIds)
                    .setContentGravity(contentGravity)
                    .setOnSelectListener(selectListener);
            popupView.popupInfo = this.popupInfo;
        ...
        public AttachListPopupView asAttachList(String[] data, int[] iconIds, int imageColor, int textColor, OnSelectListener selectListener) {
            return asAttachList(data, iconIds, imageColor, textColor, selectListener, 0, 0, Gravity.CENTER_VERTICAL);
        }
